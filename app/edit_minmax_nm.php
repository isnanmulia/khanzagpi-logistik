<?php
    ...
    if (isset($_POST["form_submit"])) {
        ...
        $qUpdateMinMax = "UPDATE gpi_minmax_nonmedis SET " . implode(",", $itmUpdate) . " WHERE kode_brng='" . $id . "' AND kd_bangsal='" . $_POST["hdn_bangsal"] . "'";
        ...
        if ($updateMinMax) {
            ...
            logError("edit_minmax_nm.php", "updateMinMax:" . $updateMinMax);
...
<html>
    ...
    <body>
        ...
        <form id="frmEditMinMax" action="" method="POST" onSubmit="return validateForm()">
            <table id="tbl_editminmaxnm" class="table">
                <tr>
                ...
                <tr>
                    <td>Stok Minimal</td>
                    <td><input type="hidden" id="hdn_min_<?php echo $id ?>" name="hdn_min_<?php echo $id ?>" value="<?php echo $minMax["min_stok"] ?>"><input type="text" id="inp_min_<?php echo $id ?>" name="inp_min_<?php echo $id ?>" class="form-control inline-input" onkeyup="removeNonNumeric(&quot;inp_min_<?php echo $id ?>&quot;);recheckMinMax(&quot;N&quot;);" style="width: 70px" autocomplete="off" value="<?php echo number_format($minMax["min_stok"], 0, ",", ".") ?>">&nbsp;&nbsp;<?php echo $minMax["satuan"] ?></td>
                </tr>
                <tr>
                    <td>Stok Maksimal</td>
                    <td><input type="hidden" id="hdn_max_<?php echo $id ?>" name="hdn_max_<?php echo $id ?>" value="<?php echo $minMax["max_stok"] ?>"><input type="text" id="inp_max_<?php echo $id ?>" name="inp_max_<?php echo $id ?>" class="form-control inline-input" onkeyup="removeNonNumeric(&quot;inp_max_<?php echo $id ?>&quot;);recheckMinMax(&quot;N&quot;);" style="width: 70px" autocomplete="off" value="<?php echo number_format($minMax["max_stok"], 0, ",", ".") ?>">&nbsp;&nbsp;<?php echo $minMax["satuan"] ?></td>
                </tr>
                <tr>
